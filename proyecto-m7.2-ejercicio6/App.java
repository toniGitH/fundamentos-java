...
public class App {
	...
	public static void main(String[] args) {
		...
		int numElegido;
		do {
			numElegido = pedirInt("Escribe un número entero:");
			primo = esPrimo(numElegido);
			// CÓDIGO ALTERNATIVO (implica hacer int numElegido="algo")
			//primo = esPrimo(pedirInt("Escribe un número entero:"));
		} while (primo==false);
		impresion(numElegido);
	...
	// RESTO DE MÉTODOS
		...
		static void impresion(int paramNumElegido) {
