...
public class App {
	...
	public static void imprimirDistancia(Circulo circulo, Circulo otroCirculo) {
		System.out.println("La distancia entre los centros es " + circulo.distanciaCirculos(otroCirculo));
	...
	// NO ESTÁ ESTRICTAMENTE MAL HECHO AQUÍ, PERO ES MÁS CORRECTO QUE, SI VOY A UTILIZAR
	// PROPIEDADES DE LA CLASE PUNTO, LOS CÁLCULOS QUE USAN ESAS PROPIEDADES, SE HAGAN EN
	// UN MÉTODO QUE ESTÉ DENTRO DE LA CLASE QUE CONTIENE ESAS PROPIEDADES.
	// En este caso, como en muchos otros, suele ser más común que en una clase "fábrica"
	// haya métodos que permitan que un objeto de esa clase compare una de sus propiedades
	// con esa misma propiedad de otro objeto de esa misma clase.
	// EJEMPLO: el método "equals()" y el "equalsIgnoreCase()"
